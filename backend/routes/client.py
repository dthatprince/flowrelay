...
from models import User, Offer, OfferStatus
...
def update_offer(offer_id: int, offer_update: OfferUpdate, current_user: User = Depends(get_current_user), db: Session = Depends(get_db)):
